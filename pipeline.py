...
def stage_body():
    ...
    if top["score"] < CFG.TITLE_SCORE_FLOOR:
        _fail([f"1위 {top['score']}점 — 확정 하한 {CFG.TITLE_SCORE_FLOOR}점 미달: "
              ...
              + ["10개 전부 다시 뽑아라. 2026-08-18 기준이 올라갔다.",
                 "① 화력이 0이면 몇 점이든 즉시 폐기다. 넷 중 하나는 반드시 넣어라 —",
                 "   모순 'A인데 B' / 대비 'A 버리고 B' / 강조 '얼마나 ~했으면' / 나이차 15살 이상",
                 "② 즉시 폐기: '그 배우'·'그 톱배우' 같은 지시대명사, "
                 "'완벽·놀란·감탄·화제·눈길·역대급' 같은 추상 서술어",
                 "③ 점수는 구체 명사에서 나온다 — 쇄골·민낯·에코백·물세안·편의점처럼 "
                 "손에 잡히는 것. '관리 비결'·'남다른 미모'는 아무 그림도 안 만든다",
                 "④ 주제어(패션·피부·명품)로 앞 20자를 채우면 감점이다. 그건 명분이지 훅이 아니다",
                 "자문해라: 이 제목을 읽으면 머릿속에 뭐가 보이나? 안 보이면 다시 써라."],
              "제목 화력")
